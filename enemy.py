...
class FlyingEnemy:
    def __init__(self):
        ...
        self.flying_enemy_rect = self.flying_enemy_surf.get_rect(bottomright = (display_obj.SCREEN_WIDTH + 200, 225))
        self.flying_enemy_speed = 6